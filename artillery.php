...
<body>
	<div id="headeur"> <img alt="logo" src="image/logo.jpg"> </div>
		...
		<div id="corps_modele">
			<h3> Voici le modèle Artillery. Prix : 110€ (couleur unique)</h3>
			<table><tr>
				<td>Artillery<br /><img alt="Nike" src="image/adidas/artillery/1.jpg" /><br />
				<form name="ajout" method="post" action="ajout_panier.php">
				Ref :<input type="test" readonly="readonly" name="ref" size="1" value="a04" />
