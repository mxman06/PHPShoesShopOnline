...
<body>
	...
	<div id="corps_produit">
		...
		while($tabresult=mysql_fetch_array($result)){
			echo '<tr><td>Ref : ';echo $tabresult["ref"];echo'<td>Prix : ';echo $tabresult["prix"];echo'€</td><td>';
			echo $tabresult["description"];echo'</td><td>Stock :';echo $tabresult["stock"];echo'</td><td><img src="';echo $tabresult["image"];echo'"</td></tr>';
		}
		echo'</table>
