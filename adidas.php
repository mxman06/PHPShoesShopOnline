...
<body>
	<div id="headeur"> <img alt="logo" src="image/logo.jpg"> </div>
		...
		<div id="corps_modele">
			<h3> Voici la gamme Adidas dont nous disposons</h3>
			<table><tr>
				<td><a href="low_rs.php"> Forum_low_rs <br /> <img alt="Nike" src="image/adidas/low_rs/1.jpg" /></a></td>
				<td><a href="artillery.php"> Artillery <br /> <img alt="Nike" src="image/adidas/artillery/1.jpg" /></a></td>
				<td><a href="nizza.php"> Nizza <br /> <img alt="Nike" src="image/adidas/nizza/1.jpg" /></a></td>
			</tr></table>
