...
<body>
	<div id="headeur"> <img alt="logo" src="image/logo.jpg"> </div>
		...
		<div id="corps_modele">
			<h3> Voici les différentes modèle des Galactica. Prix : 120€</h3>
			<table><tr>
				<td>Noir<br /><img alt="Nike" src="image/dc/galactica/1.jpg" /><br />
				<form name="ajout" method="post" action="ajout_panier.php">
				Ref :<input type="test" readonly="readonly" name="ref" size="1" value="d01" />
				Quantite :<input type="text" name="quantite" size="1" value="1" /><br />
				<input type="submit" name="ajout" value="Ajouter au Panier">
				</form></td>
				
				<td>Blancs<br /><img alt="Nike" src="image/dc/galactica/2.jpg" /><br />
				<form name="ajout" method="post" action="ajout_panier.php">
				Ref :<input type="test" readonly="readonly" name="ref" size="1" value="d02" />
				Quantite :<input type="text" name="quantite" size="1" value="1" /><br />
				<input type="submit" name="ajout" value="Ajouter au Panier">
				</form></td>
